...
## Project Structure
    ...
    ├── testapiautodatamod_125347  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_125347`
...
2. Clone this repo and `cd testapiautodatamod_125347`
